...
where $c$ is the central charge. (\tk my notes literally say ``stuff'' here.  Huang-Lepowsky paper seems to mention determinant line bundle.)
\end{enumerate}
...
Note that all the structures in this section were, despite not using the terms, examples of (partial) operads.
\end{document}
